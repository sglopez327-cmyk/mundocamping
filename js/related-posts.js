...
(function () {
  ...
  var POOL = [
    ...
    { href: 'acampar-en-espana.html', title: 'Acampar en España', tag: 'España' },
    { href: 'calculadoras.html', title: 'Calculadoras de camping', tag: 'Herramientas' },
    { href: 'kits-recomendados.html', title: 'Kits recomendados', tag: 'Kits' },
    { href: 'glosario-camping.html', title: 'Glosario de camping', tag: 'Glosario' },
    { href: 'preguntas-frecuentes-camping.html', title: 'FAQ de camping', tag: 'FAQ' },
    { href: 'pluma-vs-fibra-saco.html', title: 'Pluma vs fibra', tag: 'Comparativa' },
    { href: 'rutas-camping-fin-semana.html', title: 'Rutas de fin de semana', tag: 'Rutas' },
    { href: 'ofertas-camping-mes.html', title: 'Ofertas del mes', tag: 'Ofertas' },
