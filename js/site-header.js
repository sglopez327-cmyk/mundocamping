...
(function () {
  ...
  var NAV_ITEMS = [
    ...
    { href: '/acampar-en-espana.html', label: 'España', match: ['/acampar-en-espana', '/acampar-en-espana.html'] },
    { href: '/mejores-sitios-acampar.html', label: 'Destinos', match: ['/mejores-sitios-acampar', '/mejores-sitios-acampar.html'] },
    { href: '/calculadoras.html', label: 'Cálculos', match: ['/calculadoras', '/calculadoras.html'] },
